...
const generateMotosHTML = (motosData) => {
    ...
    $.each(motosData, function(index, moto) {
        ...
        var linkButton = $('<a>').addClass('card-text text-end').attr('href', `/occasion/${moto.id}`).appendTo(rowButton);
        $('<button>').addClass('btn btn-outline-dark btn-sm').text('Voir plus... ').appendTo(linkButton);
